...
#let night-alarm-content() = [
  ...
  #block(width: 100%, inset: 14pt, fill: red-light, radius: 8pt, stroke: 2pt + red-alert)[
    ...
    #v(6pt)
    #set text(size: 12pt)
    + #text(size: 9pt, fill: blue-dark)[Siren?] #h(6pt) — Do not process. Just move. #h(1fr) #ci[AWAKE — MOVING]
    + #text(size: 9pt, fill: blue-dark)[Shoes?] #h(6pt) — Same spot every night. #h(1fr) #ci[ON FEET]
    + #text(size: 9pt, fill: blue-dark)[Glasses & Phone?] #h(6pt) — From nightstand. #h(1fr) #ci[IN HAND]
    + #text(size: 9pt, fill: blue-dark)[Caffeine pill?] #h(6pt) — _(optional)_ Sip of water. #h(1fr) #ci[TAKEN]
  ]
  #v(0.3cm)
  #block(width: 100%, inset: 14pt, fill: rgb("#fff8e1"), radius: 8pt, stroke: 2pt + orange-warm)[
    ...
    #v(6pt)
    #set text(size: 12pt)
    5. #text(size: 9pt, fill: blue-dark)[Clothes?] #h(6pt) — Pull on whatever is laid out. Speed over appearance. #h(1fr) #ci[ON]
    6. #text(size: 9pt, fill: blue-dark)[Torch?] #h(6pt) — From nightstand if power is out. #h(1fr) #ci[IN HAND]
    7. #text(size: 9pt, fill: blue-dark)[Protected Space?] #h(6pt) — Move to shelter or front door. #h(1fr) #ci[IN POSITION]
  ]
  #v(0.3cm)
  #block(width: 100%, inset: 14pt, fill: blue-light, radius: 8pt, stroke: 2pt + blue-accent)[
    ...
    #v(6pt)
    #set text(size: 12pt)
    8. #text(size: 9pt, fill: blue-dark)[Children?] #h(6pt) — One parent → child/children. Other → go bag. #h(1fr) #ci[ROLES EXECUTING]
    9. #text(size: 9pt, fill: blue-dark)[Baby?] #h(6pt) — In babywear by door. Do not stop to dress them. #h(1fr) #ci[SECURED]
  ]
  #v(0.5cm)
